...
import { ZKIdentityVerification } from '@/components/identity/zk-identity-verification'
...
export default function ZKIdentityPage() {
  ...
  if (!isConnected) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900 transition-colors">
        {/* Header */}
          ...
          <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-purple-600 dark:text-purple-400 font-medium">ZK Identity</span>
              </div>
              <ThemeToggleSimple />
            </div>
          </nav>
            ...
            <div className="text-center">
              ...
              >
                ...
                >
                  ...
                  Prove you are a unique person without revealing personal information.
                </ResponsiveText>
              </motion.div>
        ...
        <section className="py-20 bg-gray-50 dark:bg-neutral-900 transition-colors">
          <ResponsiveContainer maxWidth="full" padding="lg">
            ...
            >
              ...
              >
                Verify your identity without compromising your privacy
              </ResponsiveText>
            </motion.div>
            ...
            <ResponsiveGrid cols={{ default: 1, sm: 2, lg: 3 }} gap="lg">
              {[
                ...
                },
                {
                  ...
                  description: 'Your personal data remains encrypted and private',
                ...
                },
                {
                  ...
                  description: 'Identity verification through blockchain technology',
